describe('Fazendo login no BugBank com cenário infeliz e cenário feliz', () => {
  ...
  it('E-mail preenchido com formato inválido', () => {
    cy.get('.style__ContainerFormLogin-sc-1wbjw6k-0 > :nth-child(1) > .input__default').type('sarita');
    cy.contains('Formato inválido').should('be.visible');
    cy.get('.style__ContainerFormLogin-sc-1wbjw6k-0 > :nth-child(1) > .input__default').clear().type('sarita@cachorro.com');
    cy.get('.style__ContainerFormLogin-sc-1wbjw6k-0 > .login__password > .style__ContainerFieldInput-sc-s3e9ea-0 > .input__default').type('12');
    cy.get('.otUnI').click();
  ...
  it('Logar o usuário Sara no BugBank', () => {
    cy.get('.style__ContainerFormLogin-sc-1wbjw6k-0 > :nth-child(1) > .input__default').type('sarita@cachorro.com');
